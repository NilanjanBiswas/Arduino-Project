	...
	<body>
		...
		<div class="container">
			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				<div class="row">
					<h3 align="center">Serach Here</h3>
				</div>
				<br>
				<form class="form-horizontal"  action="countquery.php" method="POST">
					<div class="control-group">
						<label class="control-label">ID</label>
						<div class="controls">
							<textarea name="getUID" id="getUID" placeholder="Please Tag your Card / Key Chain to display ID" rows="1" cols="1" required></textarea>
						</div>
					</div>
